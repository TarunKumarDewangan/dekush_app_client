...
const AdminDashboardScreen = () => {
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      fetchUsers();
    }, []) // The dependency array is empty, so it only re-runs on focus
  );
...
const styles = StyleSheet.create({
  ...
  header: { padding: 16, backgroundColor: '#212529', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
